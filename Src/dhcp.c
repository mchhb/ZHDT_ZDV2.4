...
//#define DHCP_DEBUG
DHCP_Get DHCP_GET;
uint8_t*  SRC_MAC_ADDR   =  EXTERN_DHCP_MAC;    // Local MAC address
...
*********************************************************************************************************
*/
uint8_t check_DHCP_state(uint8_t s) 
{
  uint16_t len;
  uint8_t  type;
...
{
  uint8_t txsize[MAX_SOCK_NUM] = {16};
  uint8_t rxsize[MAX_SOCK_NUM] = {16};
